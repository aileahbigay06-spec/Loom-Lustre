/**
 * ╔══════════════════════════════════════════════════════════════╗
 * ║  LOOM & LUSTRE — script.js  v2.0                           ║
 * ║  Cinematic interactions, magnetic cursor, parallax depth    ║
 * ╚══════════════════════════════════════════════════════════════╝
 *
 * TABLE OF CONTENTS
...
(function () {
  ...
  const sendBtn     = document.getElementById("inquirySendBtn");
  ...
  sendBtn.addEventListener("click", () => {
    ...
    if (!message) {
      msgInput.focus();
      msgInput.style.borderColor = "rgba(200,100,100,0.6)";
      setTimeout(() => msgInput.style.borderColor = "", 1500);
      return;
    }

    const to      = "aileahbigay06@gmail.com";
    const sub     = encodeURIComponent(subject || "Booking Inquiry — Loom & Lustre");
